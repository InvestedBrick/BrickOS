...
void init_gdt() {
    ...
    set_gdt_entry(1,0,0xffffffff,KERNEL_CODE_SEGMENT,GRANULARITY); // Code segment 0x08
    set_gdt_entry(2,0,0xffffffff,KERNEL_DATA_SEGMENT,GRANULARITY); // Data segment 0x10

    set_gdt_entry(3,0,0xffffffff,USER_CODE_SEGMENT,GRANULARITY); // 0x18
    set_gdt_entry(4,0,0xffffffff,USER_DATA_SEGMENT,GRANULARITY); // 0x20
